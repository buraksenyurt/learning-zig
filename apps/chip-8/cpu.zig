...
pub const Cpu = struct {
    ...
    pub fn repl(self: *@This()) void {
        ...
        // Decode
        const instr = Instruction.decode(opcode);
    ...
    pub fn replOld(self: *@This()) void {
        ...
        switch (opCode & 0xF000) {
            ...
            0x6000 => {
                ...
                const x = (opCode & 0x0F00) >> 8; // 0 ile 15 arasındaki index değerini elde etmek için 8 bit sağa kaydırma
            ...
            0x7000 => {
                ...
                // @truncate ile 16 bit'lik opCode'un sadece son 8 bit'ini alarak NN değerini elde ediyoruz.
                const nn = @as(u8, @truncate(opCode & 0x00FF));
                //
                self.v[x] +%= nn;
            },
